...
<div class="event">
	...
	<div class="participant">
		<img src="images/logo-vjug.jpg" class="logo">
		<div class="name">
			<p><a href="http://www.meetup.com/virtualJUG/">Virtual JUG</a></p>
			<p><a href="https://twitter.com/virtualJUG" title="vJUG on Twitter">@virtualJUG</a></p>
		</div>
	</div>
</div>
++++
...
<footer>
	...
	<div class="participant">
		<img src="images/logo-vjug.jpg" class="logo">
		<div class="name"><p>
			<a href="http://www.meetup.com/virtualJUG/">Virtual JUG</a>
				/ <a href="https://twitter.com/virtualJUG" title="Virtual JUG on Twitter">@virtualJUG</a>
		</p></div>
	</div>
</footer>
<script>
...
JUnit Jupiter 5.0.0-M1::
* `junit-jupiter-api`
* `junit-jupiter-engine`
JUnit Vintage 4.12.0-M1::
* `junit-vintage-engine`
JUnit Platform 1.0.0-M1::
...
IntelliJ:: EA support in https://www.jetbrains.com/idea/whatsnew/?landing::[2016.2]
...
There is a http://junit.org/junit5/docs/snapshot/user-guide/#running-tests-console-runner[console launcher]:
